...
void runProgram() {
  ...
  if(currentDelay >= checkpoint1 && currentDelay < checkpoint2) { // if the first checkpoint is reached
    setNewTarget(1,186);                                  // set new target position 1
    setNewTarget(2,100);                                  // set new target position 2
    setNewTarget(4,-15);                                  // set new target position 4
    ...
    setNewTarget(13,10);                                  // set new target position 13
    setNewTarget(14,80);                                  // set new target position 14
    setNewTarget(16,180);                                 // set new target position 16
    ...
    setNewTarget(3,115);                                  // set new target position 3
    setNewTarget(6,115);                                  // set new target position 6
    setNewTarget(9,125);                                  // set new target position 9
    setNewTarget(12,115);                                 // set new target position 12
    setNewTarget(15,100);                                 // set new target position 15
    setNewTarget(18,115);                                 // set new target position 18
  } else if(currentDelay >= checkpoint3) {                // if the third checkpoint is reached
    setNewTarget(2,80);                                   // set new target position 2
    setNewTarget(5,80);                                   // set new target position 5
    setNewTarget(8,80);                                   // set new target position 8
    setNewTarget(11,70);                                  // set new target position 11
    setNewTarget(14,60);                                  // set new target position 14
    setNewTarget(17,70);                                  // set new target position 17
    ;
  }
